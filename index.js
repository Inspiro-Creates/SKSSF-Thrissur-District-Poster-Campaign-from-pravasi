...
function getImage() {
  ...
  uploadedImageDiv.style.width = "252.73px";
  uploadedImageDiv.style.height = "303.28px";
...
function draw() {
  ...
  ctx.fillText(document.getElementById("username").value, 787, 664);
}
